<template>
  <view class="login">
    ...
    <view class="user-selector">
      ...
      <view v-if="userSelector.visible" class="dialog-area">
        <view class="dialog-list">
          <view class="dialog-list-item" v-for="(user, index) in userSelector.users" :key="index"
    ...
    <view class="password-box">
      <input v-model="password.value" class="password-input" placeholder="请输入密码" :password="!password.visible"
             type="text">
